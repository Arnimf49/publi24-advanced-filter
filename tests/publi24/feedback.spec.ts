...
test('Should send feedback successfully and show error on failure.', async ({ page, context }) => {
...
test('Should validate char limit and daily send limit.', async ({ page, context }) => {
  await utilsPubli.open(context, page);
